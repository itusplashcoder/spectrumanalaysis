...
from metrics.top_10_keywords.entrypoint import top_10_keywords_by_country, top_10_keywords_by_category  # Replace with actual module name
...
class TopKeywordsTest(unittest.TestCase):
    ...
    def test_top_10_keywords_by_country(self):
        # Mock data
        data = [
            Row(id="1", category_id="1", news_id="n1", country_id="1", news_url="url1", news_text="The quick brown fox jumps over the lazy dog.", news_title="title1", created_at=datetime.now(), updated_at=datetime.now()),
            Row(id="2", category_id="1", news_id="n2", country_id="1", news_url="url2", news_text="The quick brown fox.", news_title="title2", created_at=datetime.now(), updated_at=datetime.now()),
            Row(id="3", category_id="2", news_id="n3", country_id="2", news_url="url3", news_text="Hello world! Hello universe.", news_title="title3", created_at=datetime.now(), updated_at=datetime.now()),
            Row(id="4", category_id="2", news_id="n4", country_id="2", news_url="url4", news_text="Hello world!", news_title="title4", created_at=datetime.now(), updated_at=datetime.now())
        ]
